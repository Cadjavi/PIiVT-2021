...
export default class CategoryDashboardAdd extends BasePage<{}> {
                  ...
                  <Form.Group>
                    ...
                    >
                      ...
                      {this.state.categories.map((category) =>
                        this.createSelectOptionGroup(category)
                      )}
                    </Form.Control>
                  </Form.Group>
  ...
  private createSelectOptionGroup(
    ...
    return (
      <Fragment
        key={"category-and-subcategory-fragment-" + category.categoryId}
      >
        <option
          key={"parent-category-option-" + category.categoryId}
        ...
        {category.subcategories.map((subcategory) =>
          this.createSelectOptionGroup(subcategory, level + 1)
        )}
      </Fragment>
    );
  }
