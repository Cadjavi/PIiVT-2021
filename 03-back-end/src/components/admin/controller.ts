...
import { IAddAdministrator, IAddAdministratorValidator } from "./dto/AddAdmin";
import {
  IEditAdministrator,
  IEditAdministratorValidator,
} from "./dto/EditAdmin";
...
export default class AdministratorController extends BaseController {
  ...
  public async add(req: Request, res: Response) {
    ...
    const result = await this.services.administratorService.add(
      req.body as IAddAdministrator
    );
  ...
  public async edit(req: Request, res: Response) {
    ...
    const result = await this.services.administratorService.edit(
      id,
      req.body as IEditAdministrator
    );
