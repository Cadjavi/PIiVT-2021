...
import {
  IAdministratorLogin,
  IAdministratorLoginValidator,
} from "./dto/IAdministratorLogin";
...
export default class AuthController extends BaseController {
  ...
  public async administratorLogin(req: Request, res: Response) {
    ...
    const administrator =
      await this.services.administratorService.getByUsername(data.username);
