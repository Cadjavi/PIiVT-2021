...
export default class AuthMiddleware {
  private static verifyAuthToken(
    ...
    const administratorTokenvalidation = this.validateTokenAsTokenByRole(
      tokenString,
      "administrator"
    );
    ...
    if (
      userTokenvalidation.isValid === false &&
  ...
  private static validateTokenAsTokenByRole(
    tokenString: string,
    role: UserRole
  ): TokenValidationInformation {
    try {
